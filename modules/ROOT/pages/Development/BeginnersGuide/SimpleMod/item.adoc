...
xref:Development/BeginnersGuide/SimpleMod/gameworldmodule.adoc#_컴파일_및_저장[compile and save]!
...
xref:Development/BeginnersGuide/project_setup.adoc#_알파킷_설정[Project Setup] page.
