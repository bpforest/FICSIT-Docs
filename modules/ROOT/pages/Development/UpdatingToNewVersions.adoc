...
Remember to
xref:Development/BeginnersGuide/project_setup.adoc#_visual_studio_파일_생성[regenerate Visual Studio project files]
...
xref:Development/BeginnersGuide/project_setup.adoc#_visual_studio_파일_생성[here].
...
- Adding/removing xref:Development/ModLoader/AccessTransformers.adoc[Access Transformers]
  (note, also see link:#_무시된_접근_변환기[Seemingly Ignored Access Transformers] section)
